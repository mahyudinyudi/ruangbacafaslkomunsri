...
<head>
  ...
  <body class="logo-mini" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/unsri.4.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <
  <div class="login-logo">
    <a href="index.php" style="color: lightgoldenrodyellow;"><b>RUANG BACA<br/><b>FASILKOM UNSRI</b></a>
  </div>
